Este projeto foi desenvolvido como parte do 2º ano da Licenciatura em Engenharia Informática na Universidade do Algarve.
O objetivo principal foi implementar e otimizar estruturas de dados do zero, sem recorrer às bibliotecas do Java.

O foco no desenvolvimento foi na eficiência da pesquisa, otimização de memória e manipulação de algoritmos.
